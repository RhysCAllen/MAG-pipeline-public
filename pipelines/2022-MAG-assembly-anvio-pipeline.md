...
The pipeline was developed primarily from two resources: <a href="https://biovcnet.github.io/">BVCN</a> and <a href="https://anvio.org/">anvi'o</a>, with additional helpful info from <a href="https://maveric-informatics.readthedocs.io/en/latest/Processing-a-Microbial-Metagenome.html">MAVERIC</a> (the Sullivan lab, OSU) and the SunBeam pipeline from the Breitling Lab. This is a work-in-progress that will undergo continuous updating with version control. 
